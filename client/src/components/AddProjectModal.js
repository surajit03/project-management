...
const AddProjectModal = ({ isModalOpen, closeModal, edit = false, id = null }) => {
            ...
            axios.get(`/project/${id}`)
                .then((res) => {
                    if (res.status === 200) {
                        ...
                        // Handle the case where the resource hasn't been modified
                        // You might not need to do anything in this case
                    }
                })
                .catch((error) => {
                    toast.error('Something went wrong')
    ...
    const handleSubmit = (e) => {
        ...
        if (!edit) {
            ...
            // Rest of the code for edit mode
            ...
            // } else {
            //     // Handle token not defined error
                            ...
                            <Dialog.Panel className="rounded-md bg-white w-6/12">
                                ...
                                <form onSubmit={handleSubmit} className='gap-4 px-8 py-4'>
                                    ...
                                    <div className='flex justify-end items-center space-x-2'>
                                        ...
                                        <BtnPrimary onClick={Click} >Save</BtnPrimary>
                                    </div>
                                </form>
